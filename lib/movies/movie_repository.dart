...
class MovieRepository {
  ...
  Future<List<PopularMovie>> getAllPopularMovies() async {
    final response = await http.get(Uri.parse(ApiConectionsUrl.getAllPopularMoviesUrl));
  ...
  Future<List<PopularMovie>> getAllTrhendMovies() async {
    final response = await http.get(Uri.parse(ApiConectionsUrl.getAllTrhendsMoviesUrl));
  ...
  Future<String> getFirstVideoKey(int videoId) async {
    final response = await http.get(Uri.parse(ApiConectionsUrl.getTrailerPopularMovieUrl("$videoId")));
